...
//   import { MyContext } from "../context/MyContext";
  import myMobxStore from "../context/MyMobX";
      ...
      >
        ...
        <TitleText />
            ...
            >
              <TextInput
                placeholder={""}
                onChangeText={(text) => myMobxStore.setWeight(text)}
                value={myMobxStore.weight}
                style={{
        ...
        {changeMethod ? (
          <>
            ...
            >
              ...
              <TextInput
                placeholder={""}
                onChangeText={(text) =>myMobxStore.setHeightInMeter(text)}
                value={myMobxStore.heightInMeter}
                style={{
                  backgroundColor: "transparent",
                  width: wp(70),
                  height: hp(4),
          ...
          <>
            ...
            >
              <TextInput
                placeholder={""}
                onChangeText={(text) =>myMobxStore.setHeightInInch(text)}
                value={myMobxStore.heightInInch}
                style={{
                  backgroundColor: "transparent",
                  width: wp(30),
                  height: hp(4),
            ...
            >
              <TextInput
                placeholder={""}
                onChangeText={(text) => myMobxStore.setHeightInFeet(text)}
                value={myMobxStore.heightInFeet}
                style={{
                  backgroundColor: "transparent",
                  width: wp(30),
                  height: hp(4),
        ...
        <View style={styles.buttonView}>
          <TouchableOpacity style={styles.buttonOutStyle} 
            onPress={() => {
              myMobxStore.saveData()
            }}
           >
...
//       >
//         <TitleText />
//         <InputComponent width={84} text={"lb"} />
//         <InputComponent width={84} text={"m"} />
//         <ButtonComponent />
//         <View style={styles.buttonView}>
//           <TouchableOpacity style={styles.buttonOutStyle}>
//             <TextFields text={"Submit"} fontSize={2.1} color={"white"} />
